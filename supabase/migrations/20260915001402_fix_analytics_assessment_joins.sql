-- =============================================================================
-- Migration: 20260915001402_fix_analytics_assessment_joins.sql
-- Fix: Correct assessment table foreign key column names:
--      assessment_attempts.assessment_invitation_id (not invitation_id)
--      assessment_results.assessment_attempt_id (not attempt_id)
--      assessment_results.normalized_score (not score_percentage)
-- =============================================================================
